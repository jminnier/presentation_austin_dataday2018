...
date: 'Saturday, January 27, 2018 <br> <br> Slides available at  <font style="text-transform: lowercase;"><http://bit.ly/shiny-austin></font> <br>'
output: 
...
> - <font style="color: red;"> *Collaborator*: "How can I share my data?" </font>
> - <font style="color: blue;"> *Developer/Statistician/Data Scientist*: "How can I get people to use my new method/package?" </font>
> - <font style="color: green;"> *Developer/Statistician/Data Scientist*: "How can I create a product out of this analysis?" </font>
...
## Bonus: Teach Some things! (`learnr`)
...
Hot tip: Ted Laderas says: "Debugging is easier when you use objects instead of functions"<br>
(btw: check out his intro shiny [tutorial](https://github.com/laderast/shiny_workshop_pdxrlang))
...
Slides available at  <font style="text-transform: lowercase;"><http://bit.ly/shiny-austin></font> <br>
